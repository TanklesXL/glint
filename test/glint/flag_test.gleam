...
pub fn ints_flag_test() {
  let flag = #("flag", flag.new(flag.LI))
...
pub fn floats_flag_test() {
  let flag = #("flag", flag.new(flag.LF))
...
pub fn global_flag_test() {
  ...
  glint.new()
  |> glint.global_flag("flag", flag.new(flag.LF))
